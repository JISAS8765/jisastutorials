    ...
    <nav className="bg-[#06B6D4] text-white">
      ...
      <div className="bg-white text-black shadow-md">
        <div className="container mx-auto flex justify-between items-center py-4 px-6">
          ...
          <li><a href="#" className="hover:text-[#06B6D4]">Assignment Service</a></li>
          <li><a href="#" className="hover:text-[#06B6D4]">How We Work</a></li>
          <li><a href="#" className="hover:text-[#06B6D4]">Contact Us</a></li>
          
          </ul>

          
          <a href="#" className="bg-[#06B6D4] text-white px-4 py-2 rounded-full font-semibold hover:bg-[#06b5d4a6]">
            Get a Quote
          </a>
        </div>
      </div>
